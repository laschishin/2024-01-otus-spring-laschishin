...
class SingleBookServiceTest {
    ...
    void getTemplateVariablesEmptyBookTest() {
        ...
        Map<String, Object> actualTemplateVariables = singleBookService.getTemplateVariablesEmptyBook();
...
//        when(genreService.findAll()).thenReturn(genresList);
//
//        Map<String, Object> actualTemplateVariables = singleBookService.getTemplateVariablesEditBookForm(bookId);
//
//        assertThat(actualTemplateVariables)
//                .usingRecursiveComparison()
//                .isEqualTo(expectedTemplateVariables);
...
//    }
    ...
    void getTemplateVariablesDeleteBookTest() {
        ...
        Map<String, Object> actualTemplateVariables = singleBookService.getTemplateVariablesDeleteBook(bookId);
